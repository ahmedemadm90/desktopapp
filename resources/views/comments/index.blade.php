        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="voices" role="tabpanel" aria-labelledby="voices-tab">
                <table class="table text-capitalize text-center">
                    ...
                    @foreach (App\Models\File::where('file_type', 'voice')->get() as $file)
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('files.show', $file->id) }}">{{ __('Show') }}</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('comments.create', $file->id) }}">{{ __('Comment') }}</a>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="tab-pane fade" id="videos" role="tabpanel" aria-labelledby="videos-tab">
                <table class="table text-capitalize text-center">
                    ...
                    @foreach (App\Models\File::where('file_type', 'video')->get() as $file)
                        <tr>
                            <td>{{ $file->file_memo }}</td>
                            <td>
                                @if ($file->file_type == 'video')
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item"
                                                href="{{ route('files.show', $file->id) }}">{{ __('Show') }}</a></li>
                                        <li><a class="dropdown-item" href="#">{{ __('Comment') }}</a></li>
                                    </ul>
                                </div>
